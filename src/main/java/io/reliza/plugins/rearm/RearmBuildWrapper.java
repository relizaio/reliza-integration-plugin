...
public class RearmBuildWrapper extends SimpleBuildWrapper {
	...
	public void setUp(Context context, Run<?, ?> build, FilePath workspace, Launcher launcher,
		...
		RearmFlagsBuilder flagsBuilder = RearmFlags.builder()
				...
				.commitAuthor(RearmHelpers.resolveEnvVar("COMMIT_AUTHOR", envSuffix, initialEnvironment))
				.commitEmail(RearmHelpers.resolveEnvVar("COMMIT_EMAIL", envSuffix, initialEnvironment))
				.dateActual(RearmHelpers.resolveEnvVar("COMMIT_TIME", envSuffix, initialEnvironment))
